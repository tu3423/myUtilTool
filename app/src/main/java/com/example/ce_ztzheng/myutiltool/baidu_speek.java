...
public class baidu_speek extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baidu_speek);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(baidu_speek.this);
    ...
    public void bindParams(Intent intent) {
        ...
        if (sp.getBoolean("tips_sound", true)||1==1) {
